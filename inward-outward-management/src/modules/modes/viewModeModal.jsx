                ...
                <div className="p-10 overflow-y-auto flex flex-col gap-8 flex-1">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2">
                            ...
                            <Field label="Mode Name" value={modeName} className="border-r border-b border-gray-300"/>
                            
                            <div className="border-y col-span-2 border-gray-300 p-5 gap-2 flex flex-col">
                                <div className="text-gray-500 text-[12px]">Display Order</div>
                                <div className="text-[14px]">{displayOrder}</div>
                            </div>
