...
const ViewDepartmentModal = ({onCancel, onEdit, data}) => {

    const { departmentId, departmentName, shortName, email, phoneNo, isActive,
        remarks, createdBy, updatedBy, created_at, updated_at, institute: { instituteId, instituteName } = {} } = data;
            ...
            <div className="bg-[#f9fafb] rounded-xl max-h-260 w-230 overflow-hidden animate-slideUp flex flex-col" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="flex justify-between px-10 pt-8 pb-5 shrink-0 bg-white">
                    <div className="flex items-center gap-5">
                        <div className="bg-[#b3d0db] p-4 rounded-md">
                            <HiMiniBuildingOffice2 className="text-[#1a5c77] text-[20px]"/>
                        </div>
                        <div className="flex-1">
                            <h2 className="text-[18px] font-medium leading-10">{departmentName}</h2>
                            <span className="text-gray-500 font-mono text-[14px] inline-block">{departmentId}</span>
                        </div>
                    </div>
                ...
                <div className="p-10 overflow-y-auto flex flex-col gap-8 flex-1">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2">
                            <Field label="Departmen ID" value={departmentId} className="border-r border-b border-gray-300"/>
                            <Field label="Departmen Name" value={departmentName} className="border-l border-b border-gray-300"/>
                            <Field label="Shortname" value={shortName} className="border-t border-r border-gray-300"/>
                ...
                <div className="flex items-center justify-between px-10 py-5 bg-white"> 
                    <div className="text-[13px] text-gray-400">
                        ID <span className="text-gray-700 font-mono ml-2">{departmentId}</span> <br />
