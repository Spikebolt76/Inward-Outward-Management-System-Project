...
const ViewUserModal = ({onCancel, onEdit, data}) => {

    const { userId, fullName, username, email, phoneNo, role, isActive,
            institute: { instituteId, instituteName } = {},
            department: { departmentId, departmentName } = {},
            lastLoginAt, remarks, mustChangePassword, created_at, updated_at } = data;
            ...
            <div className="bg-[#f9fafb] rounded-xl max-h-260 w-230 overflow-hidden animate-slideUp flex flex-col" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="flex justify-between px-10 pt-8 pb-5 shrink-0 bg-white">
                    <div className="flex items-center gap-5">
                        <div className="bg-[#b3d0db] p-4 rounded-md">
                            <FaUser className="text-[#1a5c77] text-[20px]"/>
                        </div>
                        <div className="flex-1">
                            <h2 className="text-[18px] font-medium leading-10">{username}</h2>
                            <span className="text-gray-500 font-mono text-[14px] inline-block">{userId}</span>
                        </div>
                    </div>
                ...
                <div className="p-10 overflow-y-auto flex flex-col gap-8 flex-1">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2">
                            <Field label="User ID" value={userId} className="border-r border-b border-gray-300"/>
                            <Field label="Username" value={username} className="border-l border-b border-gray-300"/>
                            <Field label="Full Name" value={fullName} className="border-r border-y border-gray-300"/>
                            <Field label="Role" value={role} className="border-l border-y border-gray-300"/>

                            <div className="border-t border-r border-gray-300 p-5 gap-2 flex flex-row">
                            ...
                            <div className="border-t border-l border-gray-300 p-5 gap-2 flex flex-row">
                                <div className="flex flex-col flex-1">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2">
                            <Field label="Must Change Password On Next Login" value={mustChangePassword} className="border-b border-gray-300 col-span-2"/>
                            <Field label="Remarks" value={remarks} className="border-t border-gray-300 col-span-2"/>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2">
                            <MonoField label="Created" value={created_at} className="border-r border-b border-gray-300" />
                            <MonoField label="Modified" value={updated_at} className="border-l border-b border-gray-300" />
                            <MonoField label="Last Login At" value={lastLoginAt} className="border-t border-gray-300 col-span-2" />
                        </div>
                    </div>
                ...
                <div className="flex items-center justify-between px-10 py-5 bg-white"> 
                    <div className="text-[13px] text-gray-400">
                        ID <span className="text-gray-700 font-mono ml-2">{userId}</span> <br />
